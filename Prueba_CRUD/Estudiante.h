...
public:
	...
	Estudiante(string codigo, string nom, string ape, string dir, int tel, string fn, int ts, int i) : Persona(codigo, nom, ape, dir, tel, fn, ts){
		id = i;
	...
	void actualizar() {
		...
		string ii = to_string(id);
		if (cn.getConectar()) {
			string actualizar = "update estudiantes set id = codigo='" + codigo + "', nombres='" + nombres + "', apellidos='" + apellidos + "',direccion='" + direccion + "',telefono=" + t + ",fecha_nacimiento='" + fecha_nacimiento + "',tipo_sangre=" + ts + " where id_estudiante =" + ii + "";
